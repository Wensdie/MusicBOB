...
const teamup = {
    ...
    execute(interaciton) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const members = ((interaciton.member).voice.channel).members.filter(user => !bot.services.teams.getIgnore().includes(user.displayName) && !bot.services.teams.getIgnore().includes(user.nickname) && !(user.displayName === "MusicBOB"));
            if (members.size === 1) {
